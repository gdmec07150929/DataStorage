package com.gourd.adien.datastorage;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void spWrite(View v){
        ...
        editor.commit();
        Toast.makeText(this,"sharedPreference写入成功",Toast.LENGTH_LONG).show();
    }
    public void spRead(View v){
        SharedPreferences user = getSharedPreferences("user",MODE_APPEND);
        String acount = user.getString("acount","木有这个键值");
        String pass = user.getString("pass","木有这个键值");
        tv1.setText("账号："+acount+"\n"+"密码："+pass);
        Toast.makeText(this,"sharedPreference读取成功",Toast.LENGTH_LONG).show();
    }
